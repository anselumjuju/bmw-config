		...
		<div className="w-[90%] h-full mx-auto py-[5vh] flex items-center justify-between flex-col">
			...
			<div className="w-full flex items-end justify-between">
				<div className="w-max flex flex-col items-center justify-start gap-3">
					<div className="p-3 rounded-full grid place-content-center md:hidden bg-white/30 text-2xl text-neutral-400 cursor-pointer hover:text-neutral-600 transition-all duration-200" onClick={openEmail}><GoMail /></div>
					<div className="p-3 rounded-full grid place-content-center md:hidden bg-white/30 text-2xl text-neutral-400 cursor-pointer hover:text-neutral-600 transition-all duration-200" onClick={takeScreenshot}><BiDownload /></div>
					<div className="p-3 rounded-full grid place-content-center md:hidden bg-white/30 text-2xl text-neutral-400 cursor-pointer hover:text-neutral-600 transition-all duration-200" onClick={openShare}><FiShare2 /></div>
				</div>
				<div className="w-max h-max p-2 flex items-end md:items-center justify-end flex-col md:flex-row gap-x-6 gap-y-3 rounded-full md:bg-white/20">
					<div className="w-full pl-8 -space-y-1 text-2xl text-right">
						<p className="text-lg font-normal text-neutral-500">Total</p>
						<p><span className="font-light text-lg text-nowrap">$ </span>140,895</p>
					</div>
					<div
						className="hidden md:grid p-3 rounded-full  place-content-center bg-white/30 text-2xl text-neutral-400 cursor-pointer hover:text-neutral-600 transition-all duration-200"
